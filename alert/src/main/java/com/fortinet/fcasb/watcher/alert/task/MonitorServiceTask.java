...
@Service
public class MonitorServiceTask extends AbstractMonitorHttpTask {
    public Logger LOGGER = LoggerFactory.getLogger(MonitorServiceTask.class);
    ...
    public MonitorTypeEnum getType() {
        return MonitorTypeEnum.MONITOR_SERVICE;
    }
}
